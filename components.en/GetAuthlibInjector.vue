...
<template>
    <div class="ncard">
        <div class="ncardBody">
            <div class="card-title text">Get the latest version of authlib-injector</div>
            <div class="card-text text">
                <p><code>authlib-injector-{{ props.latest }}.jar</code> , updated on {{ props.updated }}</p>
                <a class="download-button" target="_blank" :href="props.download">
                    <FontAwesomeIcon :icon="faFileArrowDown" />&nbsp;&nbsp;Go to the developer's website
